             ...
             #       # status : 5 실패
              ...
              #  temp_str = pubdate_soup.get_text().strip()
               ...
               # print('news_pub_date : ', news_pub_date)
                ...
                desc_select = soup.select_one('body > main > article > div > div:nth-child(1) > div.topicdesc')
                ...
                # insert
                bm_insert_sql = 'insert into gn_master (news_title, news_desc, news_url,  news_comments , full_contents, ,dsf,sdf) values (?,?,?,?,?,?)'
                cur.execute(bm_insert_sql, (news_title, news_desc, news_url, news_comments ,full_contents))
                conn.commit()
